  ...
  return (
    <header className="sticky top-0 z-50 glass-panel-light border-b border-white/[0.06]">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
        ...
        <Link
          href="/academy"
          className="flex items-center gap-1.5 rounded-xl bg-amber-500 px-4 py-2 text-xs font-semibold text-black hover:bg-amber-400 transition-colors glow-amber-sm"
        >
          <Sparkles size={12} />
          시작하기
        </Link>
