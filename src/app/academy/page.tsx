...
const TRACK_ACCENT: Record<string, { bg: string; border: string; glow: string; dot: string }> = {
  ...
  tools:        { bg: "rgba(255,255,255,0.04)",  border: "rgba(255,255,255,0.10)", glow: "rgba(255,255,255,0.06)", dot: "#9ca3af" },
  ...
  "use-cases":  { bg: "rgba(255,255,255,0.04)",  border: "rgba(255,255,255,0.10)", glow: "rgba(255,255,255,0.06)", dot: "#9ca3af" },
...
const SECTION_INFO: Record<Section, { icon: string; label: string; desc: string; accent: string; border: string; glow: string }> = {
  all:        { icon: "📚", label: "전체",      desc: "모든 학습 트랙",                        accent: "rgba(255,255,255,0.80)", border: "rgba(255,255,255,0.14)", glow: "rgba(255,255,255,0.06)" },
        ...
        <div className="max-w-7xl mx-auto px-4" style={{ height: 56, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/academy" style={{ display: "flex", alignItems: "center", gap: 6, textDecoration: "none" }}>
            ...
            <span className="font-sans" style={{ fontSize: 14, fontWeight: 700 }}>
              ...
              <span style={{ color: "rgba(255,255,255,0.28)", marginLeft: 6, fontWeight: 400, fontSize: 12 }}>Academy</span>
            </span>
          </Link>
          ...
          <nav className="hidden md:flex" style={{ gap: 24, alignItems: "center" }}>
            {NAV_ITEMS.map((item) => (
              <Link key={item.label} href={item.href}
                className="font-sans"
                style={{ fontSize: 12, color: "rgba(255,255,255,0.42)", textDecoration: "none", transition: "color 150ms" }}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <Badge style={{ background: "rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.38)", border: "1px solid rgba(255,255,255,0.08)", fontSize: 11 }} className="hidden sm:flex">{MOCK_USER.role}</Badge>
            <div style={{
            ...
            <Link href="/" style={{ color: "rgba(255,255,255,0.28)", transition: "color 150ms" }}
      ...
      <main className="max-w-7xl mx-auto px-4" style={{ paddingTop: 32, paddingBottom: 64, position: "relative", zIndex: 1 }}>
        ...
        <section style={{ marginBottom: 28 }}>
          <div style={{
            ...
            background: "linear-gradient(135deg, rgba(245,158,11,0.07) 0%, rgba(5,5,8,0.60) 60%)",
            backdropFilter: "blur(20px)",
            WebkitBackdropFilter: "blur(20px)",
            padding: "36px 40px",
            boxShadow: "0 0 60px rgba(245,158,11,0.08), 0 1px 0 rgba(255,255,255,0.06) inset",
          }}>
            {/* 우상단 glow */}
            ...
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 24, flexWrap: "wrap" }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p className="font-sans" style={{ fontSize: 13, color: "rgba(255,255,255,0.42)", lineHeight: 1.65, maxWidth: 480, marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, minWidth: 160 }}>
                {[
                  ...
                  <div key={label} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <p className="font-mono" style={{ fontSize: 9, textTransform: "uppercase", letterSpacing: "0.12em", color: "rgba(255,255,255,0.30)", marginBottom: 1 }}>{label}</p>
        ...
        <section style={{ marginBottom: 28 }}>
          <div style={{
            ...
            <span className="font-sans" style={{ fontSize: 11, color: "rgba(255,255,255,0.28)", whiteSpace: "nowrap" }}>추천 역할 <strong style={{ color: "#f59e0b" }}>—</strong></span>
          </div>
        </section>
              ...
              return (
                <button key={s} onClick={() => setSection(s)}
                  style={{
                    ...
                    borderColor: isActive ? info.border : "rgba(255,255,255,0.07)",
                    backdropFilter: "blur(16px)",
                    WebkitBackdropFilter: "blur(16px)",
                    boxShadow: isActive ? `0 0 24px ${info.glow}, 0 1px 0 rgba(255,255,255,0.06) inset` : "0 1px 0 rgba(255,255,255,0.04) inset",
                ...
                >
                  ...
                  <p className="font-mono" style={{ fontSize: 10, color: isActive ? info.accent : "rgba(255,255,255,0.28)", letterSpacing: "0.04em", lineHeight: 1.4 }}>{info.desc}</p>
                </button>
              );
            })}
          </div>
              ...
              <Link key={a.id} href={`/academy/assignments/${a.id}`} style={{ textDecoration: "none" }}>
                <div style={{
                  ...
                  onMouseEnter={e => {
                    ...
                    el.style.boxShadow = "0 8px 32px rgba(239,68,68,0.10), 0 1px 0 rgba(255,255,255,0.08) inset";
                  }}
                  onMouseLeave={e => {
                    const el = e.currentTarget as HTMLElement;
                    ...
                    el.style.boxShadow = "0 4px 24px rgba(0,0,0,0.20), 0 1px 0 rgba(255,255,255,0.06) inset";
                  }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                  ...
                  <p className="font-sans" style={{ fontSize: 12, color: "rgba(255,255,255,0.38)", lineHeight: 1.6, overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}>{a.description}</p>
                  <div style={{ marginTop: 12 }}>
                    <span style={{
                      padding: "3px 10px", borderRadius: 4,
                      background: "rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.32)",
                      border: "1px solid rgba(255,255,255,0.07)", fontSize: 10,
              ...
              return (
                <Link key={track.id} href={`/academy/${track.slug}`} style={{ textDecoration: "none" }}>
                  <div style={{
                    ...
                    onMouseEnter={e => {
                      const el = e.currentTarget as HTMLElement;
                      el.style.boxShadow = `0 8px 32px ${accent.glow}, 0 1px 0 rgba(255,255,255,0.08) inset`;
                      el.style.transform = "translateY(-2px)";
                    }}
                    onMouseLeave={e => {
                      const el = e.currentTarget as HTMLElement;
        ...
        <section>
          ...
          <div style={{
            ...
            <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: 12, marginBottom: 20 }}>
              {[
                ...
                <div key={name} style={{
                  ...
                  border: "1px solid rgba(255,255,255,0.08)",
                  backdropFilter: "blur(12px)",
                  boxShadow: `0 0 24px ${glow}, 0 1px 0 rgba(255,255,255,0.06) inset`,
                }}>
                  <div style={{
                    width: 44, height: 44,
            ...
            <p className="font-sans" style={{ textAlign: "center", fontSize: 11, color: "rgba(255,255,255,0.28)" }}>
