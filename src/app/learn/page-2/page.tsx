...
export default function LearnPage2() {
  const [prompt, setPrompt] = useState(lesson.examplePrompt);
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 pb-32 pt-12">
      ...
      <div className="mb-8 flex items-center gap-1.5 text-xs text-white/30">
        ...
        <Link href="/learn/page-1" className="hover:text-white/60 transition-colors">레슨 1</Link>
        <ChevronRight size={11} />
      ...
      {/* Chips — append to prompt */}
      <div className="mb-5">
        <p className="mb-2.5 text-[10px] font-medium uppercase tracking-wider text-white/30">추가 명령 칩 — 클릭하면 프롬프트에 붙여집니다</p>
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-white/70">긴 글을 AI로 정리하기</p>
        </div>
